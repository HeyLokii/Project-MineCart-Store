...
import { insertProductSchema, insertOrderSchema, insertReviewSchema, insertUserSchema, insertFavoriteSchema, insertCartItemSchema, insertAdvertisementSchema, insertContactMessageSchema, insertSiteSettingSchema, insertNotificationSchema } from "@shared/schema";
import { z } from "zod";
import { MercadoPagoConfig, Payment } from "mercadopago";
import crypto from 'crypto';
import { eq, desc, sql, and } from 'drizzle-orm'; // Import necessary drizzle functions
import { products, orders, users, reviews, activityLogs, siteSettings, favorites, notifications } from '../shared/schema'; // Import schema
